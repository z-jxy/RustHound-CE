    ...
    for ace in aces {
        ...
        if ace.ace_type == 0x05 {
            ...
            if (MaskFlags::ADS_RIGHT_DS_CONTROL_ACCESS.bits() | mask) == mask {
                // All Extended
                if vec!["User", "Domain"].contains(&entry_type.as_str())
                    && !(&flags & ACE_OBJECT_TYPE_PRESENT == ACE_OBJECT_TYPE_PRESENT)
                {
                    relations.push(AceTemplate::new(
                        sid.to_owned(),
    ...
    static ref OBJECTTYPE_GUID_HASHMAP: HashMap<String, String> = {
        let values = [
            (
                ...
                "2bb09a7b-9acd-4082-9b51-104bb7f6a01e",
            ),
            ...
            (
                ...
                "100e454d-f3bb-4dcb-845f-8d5edc471c59",
            ),
            ...
            (
                "ms-ds-user-allowed-to-authenticate-to",
            ...
            (
                "ms-ds-syncserverurl",
                "b7acc3d2-2a74-4fa4-ac25-e63fe8b61218",
            ),
            ...
            (
                "ms-ds-cloud-issuer-public-certificates",
            ...
            (
                "ms-ds-repl-value-meta-data-ext",
            ...
            (
                "ms-ds-is-member-of-dl-transitive",
            ...
            (
                "ms-ds-authn-policy-silo-members-bl",
            ...
            (
                "ms-ds-authn-policy-silo-members",
            ...
            (
                "ms-ds-assigned-authn-policy-silo-bl",
            ...
            (
                "ms-ds-assigned-authn-policy-silo",
            ...
            (
                "ms-ds-service-allowed-to-authenticate-from",
            ...
            (
                "ms-ds-service-allowed-to-authenticate-to",
            ...
            (
                "ms-ds-computer-allowed-to-authenticate-to",
            ...
            (
                "ms-ds-user-allowed-to-authenticate-from",
            ...
            (
                "ms-ds-key-principal",
                "bd61253b-9401-4139-a693-356fc400f3ea",
            ),
            ...
            (
                "ms-ds-authn-policy-silo-enforced",
            ...
            (
                "ms-ds-assigned-authn-policy-bl",
            ...
            (
                "ms-ds-computer-authn-policy-bl",
            ...
            (
                "ms-ds-source-anchor",
                "b002f407-1340-41eb-bca0-bd7d938e25a9",
            ),
            (
            ...
            (
                ...
                "ee1f5543-7c2e-476a-8b3f-e11f4af6c498",
            ),
            (
            ...
            (
                ...
                "3a9adf5d-7b97-4f7e-abb4-e5b55c1c06b4",
            ),
